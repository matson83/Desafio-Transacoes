<section class="p-4 mb-4 bg-white rounded-lg shadow-sm card dark:bg-gray-800">
    <header class="mb-3">
        <h2 class="text-lg font-medium dark:text-black">
            {{ __('Update Password') }}
        </h2>

        <p class="mt-1 text-sm dark:text-black">
